//
//  CCTrainingVideosViewController.m
//  Cutco
//
...
@interface CCTrainingVideosViewController ()

@property (strong, nonatomic) UILabel *descriptionLabel;

@end

@implementation CCTrainingVideosViewController
...
- (void)viewDidLoad {
    ...
    self.descriptionLabel.text = @"TrainingVideos VC";
}
